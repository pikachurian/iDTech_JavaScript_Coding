 ...
 * is being updated.
 * 
 * I think the above comment is probably incorrect because the program does not count down
 * from 5 to 1, but instead, x increments from 0 to 50 and x * 2 is pushed
 * to the array.
 */
...
function checkPoint1() {
    ...
    function getMultiples() {
        while (x <= 50){
            array.push(x * 2);
            //Incremented the variable x to avoid an infinite loop.
            x ++;
        }
        return array;
    }
